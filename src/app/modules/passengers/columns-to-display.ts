...
export const detailsColumnsToDisplay = [
  ...
  //   romanianTranslation: 'PRELUARE RETR'
  // },
  //
  // {
  //   elementPropertyName: 'returnDestinationAddress',
  //   romanianTranslation: 'DESTINATIE RETR'
  // },
  // {
  //   elementPropertyName: 'returnPickUpDateTime',
  //   romanianTranslation: 'DT PRE RETUR'
  // },
  // {
